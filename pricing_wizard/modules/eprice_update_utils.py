    ...
    for market, sku in market_sku:
        for rp in rp_plans:
            ...
            if high_main > low_ref:
                ...
                wt.add_warning(warning_object('High > Low',sku,'',market,rp, 'Rental plan not using lowest 30 day price'))
                if high_main == high_ref:
                    ...
                    wt.add_warning(warning_object('High = Low',sku,'',market,rp, 'Use of lowest high price may be acceptable for promotion extention'))
    ...
    for market, sku in market_sku:
        ...
        for rp in rp_plans:
            ...
            try:
                ...
                wt.add_warning(warning_object('EU law check',sku,'',market,rp, 'Missing median high price for past 30 days'))
